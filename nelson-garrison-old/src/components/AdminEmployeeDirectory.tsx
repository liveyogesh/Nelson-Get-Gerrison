...
export default function AdminEmployeeDirectory() {
  ...
  const fetchFilters = async () => {
    try {
      const [deptRes, desRes] = await Promise.all([
        fetch(`${import.meta.env.VITE_API_URL}/api/visitors/hr/departments`),
        fetch(`${import.meta.env.VITE_API_URL}/api/visitors/hr/designations`)
      ]);
  ...
  const fetchEmployees = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/visitors/employees?${params}`);
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/visitors/employees/${editingEmp.employee_id}`, {
        method: 'PUT',
