...
const Dashboard: React.FC = () => {
    ...
    return (
      <Layout>
        <div className="space-y-6">
           ...
           <p className="text-slate-600">Welcome to your dashboard. From here, you can request Gatepasses and view your status.</p>
           <StaffPortal />
        </div>
      </Layout>
    );
      ...
      return (
          <Layout>
             <div className="space-y-6">
                ...
                <p className="text-slate-600">Employee Gatepass analytics and issues will appear here.</p>
             </div>
          </Layout>
      )
  }
  ...
  if (user?.role === 'FACILITY_ADMIN') {
      return (
          <Layout>
             <div className="space-y-6">
                <h2 className="text-2xl font-bold">Facility Admin Dashboard</h2>
                <CorporateDashboard />
             </div>
          </Layout>
      )
